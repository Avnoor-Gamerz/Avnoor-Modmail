...
client.on("channelDelete", (channel) => {
    if(channel.parentID == channel.guild.channels.cache.find((x) => x.name == "MODMAIL").id) {
        ...
        .setDescription("Your mail is now closed by a Server Administrator. Do not reply to this message unless you need help as sending a message will result in a new mail. Thanks!!")
...
client.on("message", async message => {
  ...
  if(message.guild) {
      if(command == "setup") {
          ...
          if(!message.guild.me.hasPermission("ADMINISTRATOR")) {
              return message.channel.send("Bot needs Admin Permissions to setup the modmail system!")
          }
        ...
        if(message.channel.parentID == message.guild.channels.cache.find((x) => x.name == "MODMAIL").id) {
          ...
          const channel = await message.guild.channels.create(target.id, {
              type: "text",
            parent: category.id,
            topic: "Mail is Opened by **" + message.author.username + "** to make contact with " + message.author.tag
          })
          ...
          .setColor("GREEN")
          .setThumbnail(client.user.displayAvatarURL())
          .setDescription("You have been contacted by Staff of **" + message.guild.name + "**, Please wait until he sends another message to you!");
        ...
        .setDescription("This bot is Officially made by jiren.exe#2516")
  ...
  if(!message.guild) {
      ...
      if(!main) {
          ...
          .setColor("GREEN")
          .setThumbnail(client.user.displayAvatarURL())
          .setDescription("Conversation is now started, you will be contacted by the support team soon :D")
